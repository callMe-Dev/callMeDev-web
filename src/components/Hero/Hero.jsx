...
import {HeroDiscordBtn, HeroDiscordIcon, HeroLogo, HeroStyled, HeroTextContent, HeroTitle, HeroWaveToDown} from './Hero.styles'
...
export default function Hero() {
  return (
    <HeroStyled>
      ...
      <HeroWaveToDown src={waveToDown} alt='A wave illustration for the hero section'/>
    </HeroStyled>
  )
}
